...
module.exports = function(file, opt) {
    if (!file) {
        throw new PluginError('gulp-ejs-compile-commonjs', 'Missing file option for gulp-ejs-compile-commonjs');
    }
    opt = opt || {};
    ...
    if (typeof file === 'string') {
        ...
        throw new PluginError('gulp-ejs-compile-commonjs', 'Missing path in file options for gulp-ejs-compile-commonjs');
    }
    ...
    function bufferContents(file, enc, cb) {
        ...
        if (file.isStream()) {
            this.emit('error', new PluginError('gulp-ejs-compile-commonjs',  'Streaming not supported'));
            cb();
            return;
        }
        files.push(file);
...
function ejsCompiler(files) {
    ...
    if(code.length > 0){
        ...
        return [
            '/**',
            '  * compiled by gulp-ejs-compile-commonjs',
            '  */',
            "var __a={'&':'&amp;','<':'&lt;','>':'&gt;','\"':'&quot;',\"'\":'&#39;'},",
            '   __b=/[&<>"\']/g,',
